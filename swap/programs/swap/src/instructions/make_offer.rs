...
pub struct MakeOffer<'info> {
    ...
    pub token_mint_a: InterfaceAccount<'info, Mint>, //offering token mint

    #[account(mint::token_program = token_program)]
    pub token_mint_b: InterfaceAccount<'info, Mint>, //desired token mint in exchange of the offer
    ...
    pub maker_token_account_a: InterfaceAccount<'info, TokenAccount>, //this is source of
